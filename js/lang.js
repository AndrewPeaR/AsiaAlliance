...
const aboutPage = {
    ".about-text-lang" : {
        ...
        <br />
        1. Опыт и знания: Мы имеем многолетний опыт работы в сфере ИТ и сотрудничаем с крупнейшими поставщиками, что позволяет нам предоставлять высококачественное оборудование и услуги.
        <br />
        2. Индивидуальный подход: Мы понимаем, что каждый бизнес имеет уникальные потребности, поэтому предлагаем индивидуальный подход к каждому клиенту, помогая найти оптимальные решения для его задач.
        <br />
        3. Круглосуточная поддержка: Наша компания обеспечивает круглосуточную техническую поддержку, что гарантирует бесперебойную работу вашей ИТ-инфраструктуры.
        <br />
        4. Конкурентоспособные цены: Мы предлагаем конкурентоспособные цены на оборудование и услуги, что позволяет нашим клиентам экономить бюджет.
        <br /><br />
        Если вам нужны надежные поставки оборудования, профессиональные серверные решения и надежная круглосуточная поддержка, наша компания - отличный выбор для вас.`,
